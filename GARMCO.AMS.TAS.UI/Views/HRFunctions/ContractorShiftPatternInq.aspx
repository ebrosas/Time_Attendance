<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="ContractorShiftPatternInq.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.HRFunctions.ContractorShiftPatternInq" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Contractor's Shift Pattern Inquiry</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    <tr>
                        <td style="width: 50px; text-align: right; padding-right: 5px;" rowspan="2">
                            <img alt="" src="../../Images/contractor_icon.jpg" />
                        </td>
                        <td id="tdPageTitle" runat="server" class="PageTitleLabel" style="vertical-align: bottom; padding-left: 5px; width: 900px; font-size: 11pt;">
                            Contractor's Shift Pattern Inquiry
                        </td>
                        <td style="width: 50px;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            View and manage the contractor's shift pattern
                        </td>
                        <td />
                        <td />
                    </tr>
            ...
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr style="height: 23px;">
                    ...
                    <td style="width: 200px; padding-left: 0px;">
                        <table id="tdEmployee" runat="server" border="0" style="width: 100%; text-align: left; margin: 0px; padding-left: 0px; table-layout: fixed;">
                            <tr style="vertical-align: top; margin: 0px; padding: 0px;">
                                ...
                                <td style="text-align: left; width: 30px; padding-left: 3px; display: none;">
                    ...
                    <td class="LabelBold" style="width: 120px;">
                        <asp:CustomValidator ID="cusValDateJoined" runat="server" ControlToValidate="txtGeneric" 
                    ...
                    <td style="padding-left: 0px; margin-left: 0px; width: 300px;">
                        <table border="0" style="width: 100%; text-align: left; margin: 0px; padding: 0px; table-layout: fixed;">
                            <tr>
                                <td style="width: 120px; padding-left: 0px;">
                                    <telerik:RadDatePicker ID="dtpDateJoinedStart" runat="server"
                                ...
                                <td style="width: 120px;">
                                    <telerik:RadDatePicker ID="dtpDateJoinedEnd" runat="server"
                                        Width="100%" Skin="Windows7">
                ...
                <tr style="height: 23px;">
                    ...
                    <td class="LabelBold">
                        <asp:CustomValidator ID="cusValDateResigned" runat="server" ControlToValidate="txtGeneric" 
                            CssClass="LabelValidationError" Display="Dynamic" 
                            ErrorMessage="" SetFocusOnError="true" Text="*" ToolTip="" 
                            ValidationGroup="valPrimary" onservervalidate="cusGenericValidator_ServerValidate" /> 
                        Expiration Date
                    ...
                    <td>
                        <table border="0" style="width: 100%; text-align: left; margin: 0px; padding: 0px; table-layout: fixed;">
                            <tr>
                                <td style="width: 120px; padding-left: 0px;">
                                    <telerik:RadDatePicker ID="dtpDateResignedStart" runat="server"
                                        Width="100%" Skin="Windows7">
                                ...
                                <td style="width: 120px;">
                                    <telerik:RadDatePicker ID="dtpDateResignedEnd" runat="server"
                                        Width="100%" Skin="Windows7">
                                        <Calendar ID="Calendar2" runat="server" Skin="Windows7" UseColumnHeadersAsSelectors="False" 
                                            UseRowHeadersAsSelectors="False" ViewSelectorText="x">
                                        </Calendar>
                ...
                <tr style="height: 23px;">
                    ...
                    <td colspan="3" style="padding-left: 5px; padding-top: 2px;">
                ...
                <tr>
                    <td>
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <ExportSettings ExportOnlyData="true" IgnorePaging="true" OpenInNewWindow="true" FileName="Contractor_Shift_Pattern" HideStructureColumns="true">
                            ...
                            <MasterTableView DataKeyNames="AutoID" ClientDataKeyNames="AutoID" 
                                ...
                                Font-Size="9pt" CommandItemDisplay="None">
                                ...
                                <Columns>         
                                    ...
                                    <telerik:GridBoundColumn DataField="ContractorNo" DataType="System.Int32" HeaderText="Contractor No." 
                                        ReadOnly="True" SortExpression="ContractorNo" UniqueName="ContractorNo">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle Width="115px" Font-Bold="True" />
                                        <ItemStyle Font-Bold="true" ForeColor="Purple" />
                                    </telerik:GridBoundColumn> 
                                    <telerik:GridBoundColumn DataField="ContractorName" DataType="System.String" HeaderText="Contractor Name" 
                                        ReadOnly="True" SortExpression="ContractorName" UniqueName="ContractorName">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle Width="280px" HorizontalAlign="Left" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="SupplierName" DataType="System.String" HeaderText="Contractor Company Name" 
                                        ReadOnly="True" SortExpression="SupplierName" UniqueName="SupplierName">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle Width="250px" HorizontalAlign="Left" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="GroupCode" HeaderText="Group Code" Display="false" 
                                        DataType="System.String" ReadOnly="True" SortExpression="GroupCode" UniqueName="GroupCode">
                                        <HeaderStyle Width="100px" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma"></HeaderStyle>
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="GroupDesc" HeaderText="Group Type" 
                                        DataType="System.String" ReadOnly="True" SortExpression="GroupDesc" UniqueName="GroupDesc">
                                        <HeaderStyle Width="100px" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma"></HeaderStyle>
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ReligionDesc" DataType="System.String" HeaderText="Religion" 
                                        ReadOnly="True" SortExpression="ReligionDesc" UniqueName="ReligionDesc">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                    ...
                                    <telerik:GridBoundColumn DataField="DateJoined" HeaderText="Date Started"
                                    ...
                                    <telerik:GridBoundColumn DataField="DateResigned" HeaderText="Expiration Date"
                                        DataFormatString="{0:dd-MMM-yyyy}" DataType="System.DateTime" 
            ...
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr>                    
                    <td style="padding-top: 3px; text-align: left;">
                        ...
                        <telerik:RadButton ID="btnDelete" runat="server" Text="Delete" ToolTip="Delete selected record(s)"  Width="75px"
