<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="TimesheetIntegrity.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.HRFunctions.TimesheetIntegrity" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Timesheet Integrity by Correction Code</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    <tr>
                        <td style="width: 50px; text-align: right; padding-right: 5px;" rowspan="2">
                            <img alt="" src="../../Images/timesheet_integrity_icon.png" />
                        </td>
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            Used to validate Timesheet records against the corrections made
                        </td>
                        <td />
                        <td />
                    </tr>
    ...
    <asp:Panel ID="panMain" runat="server" style="margin-top: 5px; padding-bottom: 40px;"> 
        <asp:Panel ID="panSearchCriteria" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;">
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                ...
                <tr style="height: 23px;">
                    <td class="LabelBold">
                        <asp:CustomValidator ID="cusValSearchCriteria" runat="server" ControlToValidate="txtGeneric" 
                            CssClass="LabelValidationError" Display="Dynamic" 
                            ErrorMessage="" SetFocusOnError="true" Text="*" ToolTip="" 
                            ValidationGroup="valPrimary" onservervalidate="cusGenericValidator_ServerValidate" /> 
                        Search Criteria
                    ...
                    <td class="TextNormal" style="padding-left: 3px;">
                       <telerik:RadComboBox ID="cboSearchCriteria" runat="server"
                            DropDownWidth="295px" 
                            HighlightTemplatedItems="True" 
                            Skin="Office2010Silver" 
                            Width="100%" 
                            EmptyMessage="Select Search Criteria"
                ...
                <tr>
                    <td>
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <ExportSettings ExportOnlyData="true" IgnorePaging="true" OpenInNewWindow="true" FileName="TimesheetIntegrityList" HideStructureColumns="true">
                                <Pdf PageHeight="210mm" PageWidth="310mm" PageTitle="Timesheet Integrity List" DefaultFontFamily="Arial Unicode MS"
                            ...
                            <MasterTableView DataKeyNames="AutoID" ClientDataKeyNames="AutoID" 
                                ...
                                <Columns>     
                                    ...
                                    <telerik:GridTemplateColumn DataField="CorrectionDesc" HeaderText="Description" 
                                    ...
                                    <telerik:GridBoundColumn DataField="CostCenterFullName" DataType="System.String" HeaderText="Cost Center" 
