namespace GARMCO.AMS.TAS.UI.Views.Reports
{
    ...
    /// </summary>
    public partial class EmployeeLicenseCardMore : Telerik.Reporting.Report
    {
        #region Properties
        public List<LicenseEntity> LicenseList { get; set; }
        public EmployeeEntity EmployeeDetails { get; set; }
        #endregion

        public EmployeeLicenseCardMore()
        {
            //
        ...
        private void detail_ItemDataBinding(object sender, EventArgs e)
        {
            ...
            if (section != null && section.ChildElements.Count > 0)
            {
                ...
                if (tblDetail != null)
                {
                    tblDetail.DataSource = this.EmployeeDetails;
                }
                #endregion
