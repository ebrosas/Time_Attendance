...
{
    public partial class ViewAttendanceHistory : BaseWebForm, IFormExtension
    {
        #region Enumeration
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.Master.SetPageForm(UIHelper.FormAccessCodes.VIEWATTEND.ToString());
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                this.Master.FormTitle = UIHelper.PAGE_VIEW_EMPLOYEE_ATTENDANCE_HISTORY_TITLE;
                #endregion
                ...
                if (!GAPFunction.CheckFormAccess(this.Master.FormAccess, GAPConstants.FormAccessIndex.Retrieve))
                {
                    ...
                    {
                        Response.Redirect(String.Format("{0}?error={1}&pageName={2}", UIHelper.PAGE_ERROR, Convert.ToInt32(UIHelper.PageErrorCodes.NoAccessOnPage), UIHelper.PAGE_VIEW_EMPLOYEE_ATTENDANCE_HISTORY_TITLE), true);
                    }
                }
                #endregion
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
                ...
                this.AttendanceList.Count > 0)
            {
                ...
                (
                    ...
                    UIHelper.PAGE_VIEW_ATTENDANCE_HISTORY,
                    UIHelper.QUERY_STRING_COSTCENTER_KEY,
                    string.Format("Cost Center: {0}", Server.UrlEncode(this.litCostCenter.Text.Trim())),
        ...
        private void RestoreDataFromCollection()
        {
            ...
            if (this.AttendanceHistReportStorage.ContainsKey("litEmpName"))
                this.litEmpName.Text = UIHelper.ConvertObjectToString(this.AttendanceHistReportStorage["litEmpName"]);
            else
                this.litEmpName.Text = string.Empty;

            if (this.AttendanceHistReportStorage.ContainsKey("litPosition"))
                this.litPosition.Text = UIHelper.ConvertObjectToString(this.AttendanceHistReportStorage["litPosition"]);
            else
                this.litPosition.Text = string.Empty;

            if (this.AttendanceHistReportStorage.ContainsKey("litCostCenter"))
                this.litCostCenter.Text = UIHelper.ConvertObjectToString(this.AttendanceHistReportStorage["litCostCenter"]);
            else
                this.litCostCenter.Text = string.Empty;
        ...
        private void StoreDataToCollection(UIHelper.PagePostBackFlags formFlag)
        {
            ...
            this.AttendanceHistReportStorage.Add("litEmpName", this.litEmpName.Text.Trim());
            this.AttendanceHistReportStorage.Add("litPosition", this.litPosition.Text.Trim());
            this.AttendanceHistReportStorage.Add("litCostCenter", this.litCostCenter.Text.Trim());
        ...
        private void GetAttendanceHistory(bool reloadDataFromDB = false)
        {
            try
            {
