<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="CostCenterPermission.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.AdminFunctions.CostCenterPermission" StylesheetTheme="Standard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <asp:Panel ID="panMain" runat="server" style="margin-top: 0px; padding-bottom: 40px;"> 
                        ...
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <MasterTableView DataKeyNames="EmpNo" ClientDataKeyNames="EmpNo" 
                                ...
                                <Columns>         
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="" UniqueName="ViewDetailLink" HeaderTooltip="View permitted cost center list">
								        <HeaderStyle Width="85px" HorizontalAlign="Left" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" />
								        <ItemTemplate>
									        <div style="width: 85px; text-align: left;">
                                                <asp:LinkButton ID="lnkViewDetail" runat="server" Text='View Details' 
                                                    Font-Bold="true" ForeColor="Blue" OnClick="lnkViewDetail_Click" />
									        </div>
								        </ItemTemplate>
							        </telerik:GridTemplateColumn>   
                                    <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" HeaderText="" CommandArgument="EditButton" 
                                        UniqueName="EditButton" ImageUrl="~/Images/edit_icon.png" HeaderTooltip="Edit selected record">
                                        <HeaderStyle Font-Bold="True" Width="35px"></HeaderStyle>
                                        <ItemStyle Font-Bold="true" ForeColor="Blue" HorizontalAlign="Center" />
				                    </telerik:GridButtonColumn>       
                                     <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Select" HeaderText="" CommandArgument="CopyButton" 
                                        UniqueName="CopyButton" ImageUrl="~/Images/copy_icon.png" HeaderTooltip="Copy permission set to other users">
                                        <HeaderStyle Font-Bold="True" Width="35px"></HeaderStyle>
                                        <ItemStyle Font-Bold="true" ForeColor="Blue" HorizontalAlign="Center" />
				                    </telerik:GridButtonColumn>                                        
								        ...
								        <ItemTemplate>
									        <div class="columnEllipsis" style="width: 290px; text-align: left;">
                                                ...
                                                <%--<asp:LinkButton ID="lnkEmpName" runat="server" Text='<%# Eval("EmpName") %>' 
                                                    Font-Bold="true" ForeColor="Blue" OnClick="lnkEmpName_Click" />--%>
									        </div>
								        </ItemTemplate>
							        </telerik:GridTemplateColumn>                                   
        ...
        <asp:Panel ID="panDetails" runat="server" BorderStyle="None" CssClass="PanelTitle" GroupingText="Allowed Cost Center List:" style="padding-left: 0px; padding-right: 15px; margin-top: 10px; display: none;">
                ...
                <tr>
                    <td>
                        <telerik:RadGrid ID="gridDetail" runat="server"
                            ...
                            GridLines="None" Width="100%" Height="" CellSpacing="0"
                            onpageindexchanged="gridDetail_PageIndexChanged" 
                            onpagesizechanged="gridDetail_PageSizeChanged" 
                            onsortcommand="gridDetail_SortCommand" 
                            onitemcommand="gridDetail_ItemCommand" 
                            onitemdatabound="gridDetail_ItemDataBound" 
                            Font-Names="Tahoma" Font-Size="9pt" Font-Bold="False" 
                            AllowPaging = "true" BorderStyle="Outset" BorderWidth="1px">
                            ...
                            <MasterTableView DataKeyNames="PermitID" ClientDataKeyNames="PermitID" 
                                ...
                                <Columns>        
                                    ...
                                    <telerik:GridBoundColumn DataField="CostCenterName" DataType="System.String" HeaderText="Cost Center Name" 
                                        ...
                                        <HeaderStyle Width="350px" Font-Bold="True" />
                                    </telerik:GridBoundColumn> 
                                    <telerik:GridTemplateColumn DataField="CreatedByFullName" HeaderText="Created By" 
