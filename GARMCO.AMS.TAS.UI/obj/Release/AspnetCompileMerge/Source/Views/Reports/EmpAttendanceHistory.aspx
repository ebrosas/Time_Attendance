<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="EmpAttendanceHistory.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.Reports.EmpAttendanceHistory" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Employe Attendance History Report</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 0px; margin: 0px;">
                            View the employee's attendance history records
                        </td>
                        <td />
                        <td />
                    </tr>
        ...
        <asp:Panel ID="panBody" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;" CssClass="GroupPanelHeader">
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr style="height: 23px;">
                    ...
                    <td class="LabelBold" style="width: 160px; padding-right: 7px;">
                        Employee No.
                    </td>
                ...
                <tr style="height: 23px;">
                    ...
                    <td class="LabelBold" style="padding-right: 7px;">
                        Cost Center
                    </td>
                    <td>
                ...
                <tr style="height: 23px;">
                    ...
                    <td colspan="2" style="text-align: left;">
                       <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                            <tr style="margin: 0px; padding: 0px;">                                
                                <td class="LabelBold" style="width: 160px; padding-right: 2px; color: blue;">
                                    Show Workplace Swipes
                                </td>
                                <td style="width: auto; text-align: left; padding-left: 0px; margin-left: 0px;">
                                     <asp:CheckBox ID="chkShowWorkplaceSwipe" runat="server" Text="" ToolTip="Tick to view the workplace swipe time" />
                                </td>
                            </tr>
                        </table>
                    </td>                    
            ...
            <table border="0" style="width: 100%; text-align: left; margin-top: 0px; table-layout: fixed;">
                ...
                <tr>
                    <td class="LabelNotes" style="text-align: left; color: silver; font-style: normal; padding-left: 20px;">
                        - Employee No. or Cost Center should be specified.
                    </td>
                </tr>
            </table>  
        </asp:Panel>
