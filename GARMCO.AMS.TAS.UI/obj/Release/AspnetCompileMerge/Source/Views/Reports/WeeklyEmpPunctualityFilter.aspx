<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="WeeklyEmpPunctualityFilter.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.Reports.WeeklyEmpPunctualityFilter" StylesheetTheme="Standard" %>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    <tr>
                        ...
                        <td id="tdPageTitle" runat="server" class="PageTitleLabel" style="vertical-align: bottom; padding-left: 0px; width: 900px; font-size: 11pt;">
                            Weekly Employee Punctuality Report
                        </td>
                        <td style="width: 50px;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            View the employee's punctuality report on weekly basis starting from a specified date
                        </td>
                        <td />
                        <td />
                    </tr>
            ...
            <table border="0" style="width: 100%; text-align: left; margin-top: 0px; table-layout: fixed;">
                ...
                <tr>
                    <td class="LabelNotes" style="text-align: left; color: silver; font-style: normal; padding-left: 20px;">
                        - "Cost Center" field is optional only and can be left blank
                    </td>
                </tr>
                <tr>
                    <td class="LabelNotes" style="text-align: left; color: silver; font-style: normal; padding-left: 20px;">
                        - "Date From" field is mandatory and should not be left blank. The maximum date that can be specified is equal to yesterday's date.
                    </td>
                </tr>
            </table>  
        </asp:Panel>
