<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="LateEntryDutyROTAReportFilter.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.Reports.LateEntryDutyROTAReportFilter" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>DIL Due to Late Entry of Duty Rota Report</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 0px; margin: 0px;">
                            View the list of employees who were granted DIL due to late entries of Duty Rota
                        </td>
                        <td />
                        <td />
                    </tr>
