<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="EmpPunctualityByPeriod.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.Reports.EmpPunctualityByPeriod" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Unpunctual Employees Summary</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            View the attendance summary report of all unpunctual employees based on cost center, employee number, or date range.
                        </td>
                        <td />
                        <td />
                    </tr>
