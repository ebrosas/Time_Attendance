<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="AbsenceReasonReportFilter.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.Reports.AbsenceReasonReportFilter" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Absence Reason Report</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 0px; margin: 0px;">
                            View the employee absences report
                        </td>
                        <td />
                        <td />
                    </tr>
        ...
        <asp:Panel ID="panBody" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;" CssClass="GroupPanelHeader">
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                ...
                <tr style="height: 23px;">
                    ...
                    <td style="padding-left: 4px;">
                        <asp:RadioButtonList ID="rblEmployeeType" runat="server" RepeatDirection="Horizontal" Width="100%" Font-Bold="False" Font-Size="9pt"
