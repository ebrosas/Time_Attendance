<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="DutyROTAInq.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.UserFunctions.DutyROTAInq" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Duty ROTA Entry</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    <tr>
                        <td style="width: 50px; text-align: right; padding-right: 5px;" rowspan="2">
                            <img alt="" src="../../Images/rota_icon.jpg" />
                        </td>
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            View and manage Duty ROTA entry for ICT, Engineering and Purchasing staff
                        </td>
                        <td />
                        <td />
                    </tr>
        ...
        <asp:Panel ID="panSearchCriteria" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;">
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr style="height: 23px;">
                    ...
                    <td style="width: 180px; padding-left: 0px;">
                ...
                <tr style="height: 23px;">
                    <td class="LabelBold">
                         <asp:CustomValidator ID="cusValDutyType" runat="server" ControlToValidate="txtGeneric" 
                            CssClass="LabelValidationError" Display="Dynamic" 
                            ErrorMessage="" SetFocusOnError="true" Text="*" ToolTip="" 
                            ValidationGroup="valPrimary" onservervalidate="cusGenericValidator_ServerValidate" /> 
                        Duty Type             
                    ...
                    <td style="padding-left: 3px;">
                        <telerik:RadComboBox ID="cboDutyType" runat="server"
                            DropDownWidth="175px" 
                            HighlightTemplatedItems="True" 
                            Skin="Office2010Silver" 
                            Width="100%" 
                            EmptyMessage="Select Duty Type"
                    ...
                    <td>
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <MasterTableView DataKeyNames="AutoID" ClientDataKeyNames="AutoID" 
                                ...
                                <Columns>         
                                    ...
                                    <telerik:GridTemplateColumn DataField="EmpName" HeaderText="Emp. Name" 
								        ...
								        <ItemTemplate>
									        <div class="columnEllipsis" style="width: 260px; text-align: left;">
                                    ...
                                    <telerik:GridBoundColumn DataField="CostCenter" HeaderText="CostCenter" Display="false"
                                        DataType="System.String" ReadOnly="True" SortExpression="CostCenter" UniqueName="CostCenter">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn DataField="DutyDescription" HeaderText="Duty Type" 
                                        SortExpression="DutyDescription" UniqueName="DutyDescription">
								        ...
								        <ItemTemplate>
									        <div class="columnEllipsis" style="width: 140px; text-align: left;">
										        <asp:Literal ID="litDutyDescription" runat="server" Text='<%# Eval("DutyDescription") %>' />
									        </div>
								        </ItemTemplate>
							        </telerik:GridTemplateColumn> 
                            ...
                            <ClientSettings AllowColumnsReorder="False" EnableRowHoverStyle="true">
                                ...
                                <Scrolling AllowScroll="true" UseStaticHeaders="true" SaveScrollPosition="true" ScrollHeight="" FrozenColumnsCount="4" />
            ...
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr>                    
                    <td style="padding-top: 3px; text-align: left;">
                        ...
                        <telerik:RadButton ID="btnDelete" runat="server" Text="Delete" ToolTip="Delete selected record(s)"  Width="70px"
                            CssClass="RadButtonStyle" ValidationGroup="valPrimary" Font-Size="9pt" OnClick="btnDelete_Click" Skin="Office2010Silver" />                        
                        <telerik:RadButton ID="btnPrintReport" runat="server" Text="Print Report" ToolTip="View and print Duty ROTA Report"  Width="95px"
                            CssClass="RadButtonStyle" ValidationGroup="valPrimary" Font-Size="9pt" OnClick="btnPrintReport_Click" Skin="Office2010Silver" />                        
                    </td>
                </tr>
            </table>             
        </asp:Panel>  
    ...
    <asp:Panel ID="panAjaxManager" runat="server">
        <telerik:RadAjaxManager ID="MyAjaxManager" runat="server">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="btnPrintReport">
				    <UpdatedControls>                        
					    <telerik:AjaxUpdatedControl ControlID="panMain" LoadingPanelID="loadingPanel" />  
                        <telerik:AjaxUpdatedControl ControlID="panValidator" />                          
				    </UpdatedControls>
