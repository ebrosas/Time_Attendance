<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="ManualTimesheetEntry.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.HRFunctions.ManualTimesheetEntry" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Manual Timesheet Entry</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            Allows an Administrator to manually enter the In and Out time of specific employee or contractor
                        </td>
                        <td />
                        <td />
                    </tr>
    ...
    <asp:Panel ID="panMain" runat="server" style="margin-top: 5px; padding-bottom: 40px;"> 
        <asp:Panel ID="panSearchCriteria" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;">
                ...
                <tr style="height: 23px;">
                    ...
                    <td class="TextNormal" style="width: 300px; padding-left: 0px; margin-left: 0px;">
                        <asp:RadioButtonList ID="rblOption" runat="server"  
                            ...
                            <asp:ListItem Text="Contractor" Value="valContractor" />
                        </asp:RadioButtonList>
                    </td>
            ...
            <asp:Panel ID="panContractor" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;">
                <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                    <tr style="height: 23px;">
                        <td class="LabelBold" style="width: 130px;">
                            ...
                            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                                <tr style="vertical-align: top; margin: 0px; padding: 0px;">
                                    ...
                                    <td style="width: 40px; text-align: left; padding-left: 3px; padding-top: 0px; vertical-align: top;">
                                        <telerik:RadButton ID="btnGetContractor" runat="server" Skin="Office2010Silver" Width="100%" 
                                            Text="Get" ToolTip="Get Contractor info based on the entered ID No." Enabled="true" 
                                            Font-Bold="False" Font-Size="9pt" CausesValidation="false"
                                            onclick="btnGetContractor_Click">
                                        </telerik:RadButton>
                                    </td> 
                                    <td style="text-align: left; width: 30px; padding-left: 3px; padding-top: 0px; vertical-align: top;">
                                        <telerik:RadButton ID="btnFindContractor" runat="server" Skin="Office2010Silver" 
                                            Text="..." ToolTip="Click here to search for an employee." Enabled="true" 
                                            Width="100%" Font-Bold="False" Font-Size="9pt" CausesValidation="false"
                                            onclick="btnFindContractor_Click">
                                        </telerik:RadButton>
                                    </td> 
                                    <td />
                                </tr>
                        ...
                        <td class="TextNormal" style="width: 300px;">
                            <asp:Literal ID="litContractorName" runat="server" Text="Not defined" />                                  
                        </td>
                        <td />
                    </tr>
                </table>
                ...
                <tr style="height: 23px;">
                    <td class="LabelBold" style="width: 130px;">
                        <asp:CustomValidator ID="cusValSwipeIn" runat="server" ControlToValidate="txtGeneric" 
                            ...
                            ErrorMessage="" SetFocusOnError="true" Text="*" ToolTip="" 
                            ValidationGroup="valPrimary" onservervalidate="cusGenericValidator_ServerValidate" /> 
                        <asp:CheckBox ID="chkSwipeIn" runat="server" Text="Swipe In" TextAlign="Left" 
                            SkinID="CheckBold" style="padding-left: 0px; padding-right: 0px;" AutoPostBack="True" 
                        ...
                        <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                            <tr style="height: 23px;">
                                ...
                                <td style="width: auto; text-align: left;">
                                    <telerik:RadDateInput ID="dtpTimeIn" runat="server" LabelWidth="50px" Width="80px" Culture="en-US" EmptyMessage="HH:mm:ss" ToolTip="Time Format: HH:mm:ss"
                    ...
                    <td class="LabelBold" style="width: 120px;">
                         <asp:CustomValidator ID="cusValSwipeOut" runat="server" ControlToValidate="txtGeneric" 
                            ...
                            ErrorMessage="" SetFocusOnError="true" Text="*" ToolTip="" 
                            ValidationGroup="valPrimary" onservervalidate="cusGenericValidator_ServerValidate" /> 
                        <asp:CheckBox ID="chkSwipeOut" runat="server" Text="Swipe Out" TextAlign="Left" 
                            SkinID="CheckBold" style="padding-left: 0px; padding-right: 0px;" AutoPostBack="True" 
            ...
            <table border="0" style="width: 100%; text-align: left; margin-top: 0px; table-layout: fixed;">
                ...
                <tr>
                    <td class="LabelNotes" style="text-align: left; color: silver; font-style: normal; padding-left: 20px;">
                        - The maximum date that can be selected for both Swipe In and Swipe Out is today's date.
                        <br />
                        - Swipe time is required if date is specified.
                    </td>
                </tr>
            </table>         
        </asp:Panel>  
        ...
        <telerik:RadAjaxManager ID="MyAjaxManager" runat="server">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="btnFindEmployee">
                 ...
                 <telerik:AjaxSetting AjaxControlID="btnGetContractor">
				    <UpdatedControls>                        
					    <telerik:AjaxUpdatedControl ControlID="panMain" LoadingPanelID="loadingPanel" />  
                        <telerik:AjaxUpdatedControl ControlID="panValidator" />                          
				    </UpdatedControls>
			    </telerik:AjaxSetting>   
                <telerik:AjaxSetting AjaxControlID="btnFindContractor">
				    <UpdatedControls>                        
					    <telerik:AjaxUpdatedControl ControlID="panMain" LoadingPanelID="loadingPanel" />  
                        <telerik:AjaxUpdatedControl ControlID="panValidator" />                          
				    </UpdatedControls>
