<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="OvertimeApproval.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.HRFunctions.OvertimeApproval" StylesheetTheme="Standard" %>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            Manage employee overtime and meal voucher
                        </td>
                        <td />
                        <td />
                    </tr>
            ...
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                ...
                <tr style="height: 23px;">
                    ...
                    <td colspan="3" style="padding-left: 0px; padding-top: 5px;">
                        ...
                        <telerik:RadButton ID="btnSave" runat="server" Text="Save / Update" ToolTip="Save changes to database" Width="110px" 
                ...
                <tr>
                    <td>
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <ExportSettings ExportOnlyData="true" IgnorePaging="true" OpenInNewWindow="true" FileName="Attendance List" HideStructureColumns="true">
                            ...
                            <MasterTableView DataKeyNames="AutoID" ClientDataKeyNames="AutoID" 
                                ...
                                <Columns>         
                                    ...
                                    <telerik:GridBoundColumn DataField="CostCenter" DataType="System.String" HeaderText="Cost Center" 
                                        ...
                                        <HeaderStyle Width="90px" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" />
                                    </telerik:GridBoundColumn> 
                                    ...
                                    <telerik:GridTemplateColumn DataField="OTDurationHour" DataType="System.String" HeaderText="OT Duration <br/> (hh:mm)" 
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtDuration" runat="server" width="70px" 
                                                ...
                                                Skin="Office2010Silver" DataType="System.Int32" MaxLength="4" Enabled="false"
                                    ...
                                    <telerik:GridTemplateColumn DataField="OTReason" HeaderText="OT Reason" DataType="System.String" 
								        ...
								        <HeaderStyle Width="200px" HorizontalAlign="Center" Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" />
								        <ItemTemplate>     
                                    ...
                                    <telerik:GridTemplateColumn DataField="LastUpdateUser" HeaderText="Last Update User" DataType="System.String" 
