<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="EmpShiftPatternInq.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.UserFunctions.EmpShiftPatternInq" StylesheetTheme="Standard" %>
        ...
        <asp:Panel ID="panSearchCriteria" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;">
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr style="height: 23px;">
                    <td id="tdEmployeeTitle" runat="server" class="LabelBold" style="width: 105px;">
                        Employee No.      
                    </td>
                        ...
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <MasterTableView DataKeyNames="AutoID" ClientDataKeyNames="AutoID" 
                                ...
                                <Columns>        
                                    ...
                                    <telerik:GridBoundColumn DataField="ParentCostCenter" DataType="System.String" HeaderText="Parent Cost Center" 
                                        ReadOnly="True" SortExpression="ParentCostCenter" UniqueName="ParentCostCenter">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                    ...
                                    <telerik:GridBoundColumn DataField="CostCenterFullName" DataType="System.String" HeaderText="Working Cost Center" 
                                    ...
                                    <%--<telerik:GridTemplateColumn DataField="CostCenterFullName" HeaderText="Working Cost Center" 
                            ...
                            <ClientSettings AllowColumnsReorder="True" EnableRowHoverStyle="true" ColumnsReorderMethod="Reorder" ReorderColumnsOnClient="True">
