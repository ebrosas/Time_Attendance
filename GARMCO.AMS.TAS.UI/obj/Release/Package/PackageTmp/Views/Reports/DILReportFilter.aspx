<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="DILReportFilter.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.Reports.DILReportFilter" StylesheetTheme="Standard" %>

<%@ MasterType VirtualPath="~/Views/Shared/TASMaster.Master" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Day In Lieu Report</title>
</asp:Content>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 0px; margin: 0px;">
                            View the employee's day in lieu entitlements and usage history
                        </td>
                        <td />
                        <td />
                    </tr>
