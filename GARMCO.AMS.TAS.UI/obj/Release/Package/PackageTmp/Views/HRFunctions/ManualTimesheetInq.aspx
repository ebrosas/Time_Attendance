<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TASMaster.Master" AutoEventWireup="true" CodeBehind="ManualTimesheetInq.aspx.cs" 
    Inherits="GARMCO.AMS.TAS.UI.Views.HRFunctions.ManualTimesheetInq" StylesheetTheme="Standard" %>
                ...
                <table border="0" style="width: 100%; text-align: left;">
                    ...
                    <tr>
                        <td class="PageDescriptionHeader" style="text-align: left; vertical-align: top; padding-left: 5px; margin: 0px;">
                            Allows an Administrator to manually enter the In and Out time of specific employee
                        </td>
                        <td />
                        <td />
                    </tr>
        ...
        <asp:Panel ID="panSearchCriteria" runat="server" BorderStyle="None" style="padding: 0px; margin: 0px;">
            <table border="0" style="width: 100%; text-align: left; margin: 0px; table-layout: fixed;">
                <tr style="height: 23px;">
                    ...
                    <td class="LabelBold" style="width: 80px;">
                        Date In
                    </td>
                    <td style="width: 150px;">
                        <telerik:RadDatePicker ID="dtpDateIn" runat="server"
                ...
                <tr style="height: 23px;">
                    ...
                    <td>
                        <telerik:RadDatePicker ID="dtpDateOut" runat="server"
                            Width="120px" Skin="Windows7">
                        ...
                        <telerik:RadGrid ID="gridSearchResults" runat="server"
                            ...
                            <MasterTableView DataKeyNames="AutoID" ClientDataKeyNames="AutoID" 
                                ...
                                <Columns>         
                                    ...
                                    <telerik:GridButtonColumn ButtonType="LinkButton" CommandName="Select" Text="View" UniqueName="ViewLinkButton" HeaderTooltip="View details about the selected record">
                                        <HeaderStyle Width="40px" HorizontalAlign="Center" Font-Bold="true" Font-Size="9pt" />
                                        <ItemStyle HorizontalAlign="Center" Font-Bold="true" Font-Size="9pt" ForeColor="Blue" />
					                </telerik:GridButtonColumn>      
                                    ...
                                    <telerik:GridBoundColumn DataField="dtIN" HeaderText="Date In"
                                    ...
                                    <telerik:GridBoundColumn DataField="TimeIn" HeaderText="Time In"
                                        DataFormatString="{0:HH:mm tt}" DataType="System.DateTime" 
                                        FilterControlAltText="Filter Time In column" ReadOnly="True" SortExpression="TimeIn" UniqueName="TimeIn">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" Width="80px"></HeaderStyle>
                                    </telerik:GridBoundColumn> 
                                    <telerik:GridBoundColumn DataField="dtOUT" HeaderText="Date Out"
                                        DataFormatString="{0:dd-MMM-yyyy}" DataType="System.DateTime" 
                                    ...
                                    <telerik:GridBoundColumn DataField="TimeOut" HeaderText="Time Out"
                                        DataFormatString="{0:HH:mm tt}" DataType="System.DateTime" 
                                        FilterControlAltText="Filter Time Out column" ReadOnly="True" SortExpression="TimeOut" UniqueName="TimeOut">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                        <HeaderStyle Font-Bold="True" Font-Size="8pt" Font-Names="Tahoma" Width="80px"></HeaderStyle>
