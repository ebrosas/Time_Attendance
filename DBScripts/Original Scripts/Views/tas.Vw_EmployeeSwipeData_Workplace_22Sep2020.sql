...
/****** Object:  View [tas].[Vw_EmployeeSwipeData_Workplace]    Script Date: 22/09/2020 14:09:27 ******/
SET ANSI_NULLS ON
GO
	...
	(
		...
		(
			...
			SELECT 
				...
				--		ELSE 0 
				--	END NOT IN (10001743) 
				--	THEN DATEADD(hh, 3, CONVERT(DATETIME, CONVERT(VARCHAR, a.TimeDate, 126))) 
				--	ELSE CONVERT(DATETIME, CONVERT(VARCHAR, a.TimeDate, 126))
				--END AS SwipeTime,
				--End of Rev. #1.3
