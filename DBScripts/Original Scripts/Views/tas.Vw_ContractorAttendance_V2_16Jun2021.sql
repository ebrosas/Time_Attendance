...
/****** Object:  View [tas].[Vw_ContractorAttendance_V2]    Script Date: 16/06/2021 13:55:19 ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	FROM tas.sy_PrintedCards a WITH (NOLOCK)
		...
		LEFT JOIN tas.sy_Vw_LIC_PrintedCards e WITH (NOLOCK) ON (CASE WHEN ISNUMERIC(a.EmpNo) = 1 THEN CONVERT(INT, a.EmpNo) ELSE 0 END) = e.EmpNo	--Rev. #1.3
