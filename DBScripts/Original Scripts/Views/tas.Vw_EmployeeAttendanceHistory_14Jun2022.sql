...
/****** Object:  View [tas].[Vw_EmployeeAttendanceHistory]    Script Date: 14/06/2022 08:32:54 ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	FROM (
			...
			WHERE DT BETWEEN CONVERT(DATETIME, CONVERT(VARCHAR, DATEADD(YEAR, -2, GETDATE()), 12)) AND CONVERT(DATETIME, CONVERT(VARCHAR, GETDATE(), 12))
		) a	
