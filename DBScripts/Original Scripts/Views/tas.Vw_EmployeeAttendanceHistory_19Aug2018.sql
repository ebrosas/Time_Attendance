...
/****** Object:  View [tas].[Vw_EmployeeAttendanceHistory]    Script Date: 19/08/2018 14:25:35 ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	SELECT	a.AutoID,
			...
			a.LastUpdateUser,
			a.LastUpdateTime								
	FROM Archive.dbo.tas2_Tran_Timesheet_2011 a
		LEFT JOIN tas.GetRemark02 b ON a.AutoId = b.AutoId
		LEFT JOIN tas.Master_ShiftPatternTitles c ON RTRIM(a.ShiftPatCode) = RTRIM(c.ShiftPatCode) 	
		LEFT JOIN tas.Tran_WorkplaceSwipe d ON a.EmpNo = d.EmpNo AND a.DT = d.SwipeDate
	--*/
	...
	SELECT	a.AutoID,
			...
			a.LastUpdateUser,
			a.LastUpdateTime								
	FROM Archive.dbo.tas2_Tran_Timesheet_2012 a
		LEFT JOIN tas.GetRemark02 b ON a.AutoId = b.AutoId
		LEFT JOIN tas.Master_ShiftPatternTitles c ON RTRIM(a.ShiftPatCode) = RTRIM(c.ShiftPatCode) 	
		LEFT JOIN tas.Tran_WorkplaceSwipe d ON a.EmpNo = d.EmpNo AND a.DT = d.SwipeDate
	--*/
	...
	SELECT	a.AutoID,
			...
			a.LastUpdateUser,
			a.LastUpdateTime								
	FROM Archive.dbo.tas2_Tran_Timesheet_2013 a
		LEFT JOIN tas.GetRemark02 b ON a.AutoId = b.AutoId
		LEFT JOIN tas.Master_ShiftPatternTitles c ON RTRIM(a.ShiftPatCode) = RTRIM(c.ShiftPatCode) 	
		LEFT JOIN tas.Tran_WorkplaceSwipe d ON a.EmpNo = d.EmpNo AND a.DT = d.SwipeDate
	--*/
