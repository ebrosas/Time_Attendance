...
/****** Object:  View [tas].[Master_Employee_JDE_View_V2]    Script Date: 02/09/2017 14:29:36 ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	SELECT     
		...
		LTRIM(RTRIM(ISNULL(f.EAEMAL, ''))) AS EmpEmail,
	...
	FROM tas.syJDE_F060116 a
		...
		LEFT JOIN tas.syJDE_F01151 f ON a.YAAN8 = f.EAAN8 AND f.EAIDLN = 0 AND f.EARCK7 = 1 AND UPPER(LTRIM(RTRIM(f.EAETP))) = 'E' --AND f.EAEHIER = 1 
