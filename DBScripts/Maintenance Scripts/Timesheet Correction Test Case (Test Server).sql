	...
	--Not Applicable
	SELECT a.CorrectionCode, a.ShiftCode,
	 * FROM tas.Tran_Timesheet a
	WHERE 
		YEAR(a.DT) = 2016
		AND a.EmpNo > 10000000
	...
	SELECT a.CorrectionCode, a.RemarkCode,
	 * FROM tas.Tran_Timesheet a
	WHERE 
		YEAR(a.DT) = 2016
		AND a.EmpNo > 10000000
	...
	SELECT a.CorrectionCode, a.LeaveType,
	* FROM tas.Tran_Timesheet a
	WHERE 
		YEAR(a.DT) = 2016
		AND a.EmpNo > 10000000
	...
	SELECT TOP 100
		a.CorrectionCode, a.RemarkCode, a.AbsenceReasonCode, a.AbsenceReasonColumn, a.LeaveType, a.GradeCode, a.DIL_Entitlement,
		a.* 
	FROM tas.Tran_Timesheet a
		INNER JOIN tas.Master_Employee_JDE_View_V2 b ON a.EmpNo = b.EmpNo
	WHERE 
...
/*	Checking:
	...
	SELECT a.Processed, a.IsLastRow, a.CorrectionCode, a.RemarkCode, a.AbsenceReasonCode, a.AbsenceReasonColumn, a.LeaveType, a.DIL_Entitlement,
		a.* 
	FROM tas.Tran_Timesheet a
		INNER JOIN tas.Master_Employee_JDE_View_V2 b ON a.EmpNo = b.EmpNo
	WHERE a.IsLastRow = 1 
		AND a.EmpNo = 10001422
		AND a.DT = '31/03/2016'
	ORDER BY a.DT DESC 
