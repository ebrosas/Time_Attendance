...
*	Revision History
*
*	Name: tas.PR_GetShiftProjectionByEmpNo
*	Description: This procedure is used to calculate the shift projection of specific employee for 1 month period based on the start date
*
*	Date:			Author:		Rev.#:		Comments:
*	04/08/2019		Ervin		1.0			Created
**************************************************************************************************************************************************************/

CREATE PROCEDURE tas.PR_GetShiftProjectionByEmpNo
(
	@empNo			INT,
	@startDate		DATETIME
)
...
/*	Debug:
	...
	EXEC tas.PR_GetShiftProjectionByEmpNo 10003632, '08/01/2019'
