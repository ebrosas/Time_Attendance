...
*	Revision History
*
*	Name: tas.Vw_OTBudgetHours
*	Description: Retrieves the overtime budget work hours breakdown
*
*	Date:			Author:		Rev. #:		Comments:
*	07/03/2018		Ervin		1.0			Created
************************************************************************************************************************************************/

ALTER VIEW tas.Vw_OTBudgetHours
AS		
...
/* Testing:
	...
	SELECT * FROM tas.Vw_OTBudgetHours a
