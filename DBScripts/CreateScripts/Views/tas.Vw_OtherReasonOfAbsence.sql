...
*	Revision History
*
*	Name: tas.Vw_OtherReasonOfAbsence
*	Description: Get the list of all exceptional leaves 
*
*	Date:			Author:		Rev. #:		Comments:
*	17/10/2020		Ervin		1.0			Created
************************************************************************************************************************************************/

ALTER VIEW tas.Vw_OtherReasonOfAbsence
AS	
	...
	SELECT DISTINCT 
		...
		'Exceptional Leave' AS DayBeforeLeaveStartDateDesc,
	...
	WHERE 
		...
		RTRIM(a.AbsenceReasonCode) NOT IN ('WH', 'BT', 'RT', 'EL', 'SL')
...
/*	Debug:
	...
	SELECT * FROM tas.Vw_OtherReasonOfAbsence a
