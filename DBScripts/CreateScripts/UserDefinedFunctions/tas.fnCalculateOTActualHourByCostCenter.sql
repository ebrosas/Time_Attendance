...
*	Revision History
*
*	Name: tas.fnCalculateOTActualHourByCostCenter
...
ALTER FUNCTION tas.fnCalculateOTActualHourByCostCenter 
(
	@fiscalYear		INT,
...
BEGIN
	...
	SELECT	@totalOTDuration = ISNULL(@janActual, 0) + ISNULL(@febActual, 0) + ISNULL(@marActual, 0) + ISNULL(@aprActual, 0) + ISNULL(@mayActual, 0) + ISNULL(@junActual, 0) + ISNULL(@julActual, 0) + ISNULL(@augActual, 0) + ISNULL(@sepActual, 0) + ISNULL(@octActual, 0) + ISNULL(@novActual, 0) + ISNULL(@decActual, 0)

	RETURN ISNULL(@totalOTDuration, 0) 
...
PARAMETERS:
	...
	SELECT tas.fnCalculateOTActualHourByCostCenter(2018, '')
	SELECT tas.fnCalculateOTActualHourByCostCenter(2018, '2111')
