DECLARE	@startDate	DATETIME = 	'07/01/2021',
	...
	SELECT	a.EmpNo AS 'Emp. No.', 
			b.EmpName AS 'Emp. Name',
			RTRIM(b.BusinessUnit) AS 'Cost Center',
			RTRIM(c.BUname) AS 'Cost Center Name',
			b.GradeCode AS 'Pay Grade',
			a.SwipeDate AS 'Swipe Date',
			a.SwipeTime AS 'Swipe Time',
			a.SwipeLocation AS 'Swipe Location',
			a.SwipeType AS 'Swipe Type'
		--a.* 
	...
	ORDER BY b.BusinessUnit, a.EmpNo, a.SwipeDate